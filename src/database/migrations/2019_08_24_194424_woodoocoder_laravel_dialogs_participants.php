...
class WoodoocoderLaravelDialogsParticipants extends Migration {
    ...
    public function up() {
        ...
        Schema::create($tablePrefix.'participants', function (Blueprint $table) use ($tablePrefix) {
    ...
    public function down(){
        ...
        Schema::dropIfExists($tablePrefix.'participants');
    }
}
